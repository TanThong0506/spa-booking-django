...
- Hỗ trợ 2 cách deploy thực tế:
  - **Render.com** (auto-trigger via webhook)
  - **VPS SSH** (git pull + docker compose up)
- Tạo bản ghi trong tab **Deployments** của GitHub

Setup guide chi tiết: `docs/GITHUB_CD_SETUP.md`
